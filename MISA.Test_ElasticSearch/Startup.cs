...
using MISA.Test_ElasticSearch.Controllers;
using Nest;
...
namespace MISA.Test_ElasticSearch
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Đăng kí NEST ElasticClient
            var settings = new ConnectionSettings(new Uri(connectionString)).DefaultIndex("recipe.recipes");
